<div id="header" align="center">
  <!-- Avatar GIF -->
  <img src="https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExc2hyNWlucWVtMWR1OGV1cGk3amJkMDV0d2FrMmZrZGR6dWgzaHFpMCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/JKcgeRTy0rty5huqlB/giphy.gif" width="120" />
  ...
  <h1>
  Hi, I’m Ivonne <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="25" alt="waving hand"/> <br>
  <sub>QA Automation | Software Testing | API Testing 🦋 </sub>
</h1>
</div>

<div align="center">
  <!-- Banner GIF -->
  <img src="https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExd3h6ZnB6Mml3YzNmdGk2ZGhncG9jM2p6N3dyYzhmNGt1ZTU3YjI5bSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/k0ijJhqrUP4T2EvmJ1/giphy.gif" width="400" height="300" alt="tech banner"/>
</div>
...
• API testing and request validation with Postman  
• Git workflows and test project organisation
...
Automation tests built with Playwright and TypeScript to validate smoke and UI scenarios.
Uses assertions and the Page Object Model (POM) to structure tests.

🔹[Bug Reporting Practice](https://github.com/IvonneValenzuela/BugReportingPractice)

Exploratory testing exercises including bug reports, reproduction steps, and test documentation.

🔹[Personal Automation Hub](https://github.com/IvonneValenzuela/PersonalAutomationHub)

Creative automation projects built for real-life needs, such as checking supermarket prices and monitoring pet food availability.
